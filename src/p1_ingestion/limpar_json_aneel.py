"""
limpar_json_aneel.py  [VERSÃO ATUALIZADA — 3 anos]
====================
Pessoa 1 — Data Engineer · Sprint Dia 1 (manhã)

Processa os 3 arquivos de metadados da ANEEL (2016, 2021, 2022)
e gera dois arquivos consolidados limpos:

  aneel_limpo_completo.json     → todos os 18.688 registros
  aneel_vigentes_completo.json  → apenas vigentes (17.586 registros)
...
Uso:
  ...
  python limpar_json_aneel.py --input2016 caminho/2016.json
                              --input2021 caminho/2021.json
                              --input2022 caminho/2022.json
                              --output pasta_saida/
