...
Uso:
  ...
  python src/p1_ingestion/unir_parquets.py --preview   # só mostra estatísticas
"""
...
def main():
    ...
    if not path_pdfs.exists():
        ...
        log.error("Rode primeiro: python src/p1_ingestion/parser.py")
        return
    ...
    log.info(f"  python src/p2_search/p2_indexar.py \\")
