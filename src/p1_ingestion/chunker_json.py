...
Uso — rodar da RAIZ do projeto:
  ...
  python src/p1_ingestion/chunker_json.py --ano 2016
  python src/p1_ingestion/chunker_json.py --ano 2016 --limite 50   # teste
  python src/p1_ingestion/chunker_json.py --incluir-sem-ementa      # inclui todos
