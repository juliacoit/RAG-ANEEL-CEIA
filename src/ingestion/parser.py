...
Uso:
  python src/ingestion/parser.py             # tudo
  python src/ingestion/parser.py --limite 50 # teste rápido
  python src/ingestion/parser.py --ano 2022  # só 2022
  python src/ingestion/parser.py --workers 8 # menos RAM
  python src/ingestion/parser.py --sem-checkpoint  # ignora checkpoint
"""
...
def main():
    ...
    log.info("=" * 55)
    log.info("\nProximos passos:")
    log.info("  1. python src/ingestion/unir_parquets.py")
    log.info("  2. python src/search/indexar.py --parquet data/processed/chunks_completo_unificado.parquet --resetar")
